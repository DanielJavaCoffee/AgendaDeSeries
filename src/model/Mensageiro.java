...
public class Mensageiro {
	...
	public static void enviarProgramacaoDeHoje(String assunto, String email, String string) {
		...
		try {
			...
			Address[] toUser = InternetAddress.parse(email); // destinatário

			message.setRecipients(Message.RecipientType.TO, toUser);
			message.setSubject(assunto);
			message.setText("Seus Dados: " + string);
